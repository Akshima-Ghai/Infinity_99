...
import com.pranjal.video.fragments.PreviewCallFragment


import com.pranjal.video.utils.*
...
//    }
    ...
    override fun onReceiveHangUpFromUser(session: QBRTCSession, userId: Int, userInfo: MutableMap<String, String>?) {
        ...
        Toast.makeText(applicationContext, "User " + getUserNameOrLogin(userId) + " " + getString(R.string.text_hang_up), Toast.LENGTH_SHORT).show()
    }
