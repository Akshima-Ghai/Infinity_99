...
import com.pranjal.video.fragments.BaseToolBarFragment
import com.pranjal.video.utils.EXTRA_IS_INCOMING_CALL
import com.pranjal.video.utils.EXTRA_QB_USERS_LIST
import com.quickblox.chat.QBChatService
import com.pranjal.video.adapters.OpponentsCallAdapter
...
class VideoConversationFragment : BaseToolBarFragment(), QBRTCSessionStateCallback<QBRTCSession>, QBRTCClientVideoTracksCallbacks<QBRTCSession> {
    ...
    private fun initRecyclerView() {
        ...
        recycler_view_opponents.addItemDecoration(DividerItemDecoration(requireContext(), R.dimen.grid_item_divider))
    ...
    private fun initAdapter() {
        ...
        opponentsAdapter = OpponentsCallAdapter(requireContext(), qbUsers, cellSizeWidth, cellSizeHeight)
