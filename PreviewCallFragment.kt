package com.pranjal.video.fragments
...
import com.pranjal.video.utils.MAX_OPPONENTS_COUNT
import com.pranjal.video.view.CameraPreview
...
class PreviewCallFragment : BaseToolBarFragment() {
    ...
    private fun initFields() {
        requireArguments().get(EXTRA_QB_USERS_LIST).let {
            if (it is ArrayList<*>) {
    ...
    private fun startCameraPreview() {
        cameraPreview = CameraPreview(requireActivity(), Camera.CameraInfo.CAMERA_FACING_FRONT)
